...
<html>
<head>
    <title>Login Manager Page</title>
        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <form:form id="login-form" modelAttribute="manager" action="login" method="post"  class="form">
                        <h3 class="text-center text-info">Login</h3>
                        <div class="form-group">
                            <label for="username" class="text-info">Username:</label><br>
                            <form:input type="email" name="emailAddress" id="username" class="form-control" path="emailAddress"/>
                            <form:errors path="emailAddress"/>
                        </div>
                        <div class="form-group">
                            <label for="password" class="text-info">Password:</label><br>
                            <form:input type="text" name="password" id="password" class="form-control" path="password"/>
                            <form:errors path="emailAddress"/>
                        </div>
                        <div class="form-group">
