...
<nav id="navbar" class="bg-dark">
    ...
    <ul>
        ...
        <li><a href="<c:url value="/"/>" class="text-white">Add Offer To Order</a></li>
    </ul>
...
<form:form cssClass="p-3 m-3" action="showOrders" modelAttribute="offer"  method="post">
    <table class="table table-bordered table-striped text-info">
        ...
        <tr>
            ...
            <td>
                <form:input name="proposedPrice" id="proposedPrice" path="proposedPrice"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <form:input name="durationOfWork" id="durationOfWork" path="durationOfWork"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <form:input type="time"  name="startTime" id="startTime" path="startTime"/>
            </td>
        </tr>
