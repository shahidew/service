...
<style>
    ...
    body, html{
        ...
        background: #b1b1b1 url(https://i.ytimg.com/vi/4kfXjatgeEU/maxresdefault.jpg) no-repeat;
...
<div class="container">
    <div class="row main">
        <div class="main-login main-center">
            ...
            <form:form class="" modelAttribute="customer" method="post" action="register">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <form:input type="text" class="form-control" name="name" id="name"  placeholder="Enter your Name" path="fullName"/>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <form:input type="text" class="form-control" name="email" id="email"  placeholder="Enter your Email" path="emailAddress"/>
                ...
                <div class="form-group ">
                    <button id="button" type="submit" class="btn btn-primary btn-lg btn-block login-button">Register</button>
                </div>
