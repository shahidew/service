...
<div id="login">
    <h3 class="text-center text-white pt-5">${customer.emailAddress}</h3>
    <h3 class="text-center text-white pt-5">${customer.password}</h3>
    <div class="container">
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div class="login-box col-md-12">
                    <form:form method="post" action="changePass" modelAttribute="customer" id="login-form" class="form">
