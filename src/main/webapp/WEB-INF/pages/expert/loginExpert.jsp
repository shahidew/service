...
<nav id="navbar" class="bg-dark">
    <h1 class="logo">
        <a class="text-white" href="<c:url value="/hom/"/>">
                ...
                <div id="login-box" class="col-md-12">
                    <form id="login-form" action="login" method="post"  class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="emailAddress" id="username" class="form-control" path="emailAddress"/>
                        </div>
                        <div class="form-group">
                            <label for="password" class="text-info">Password:</label><br>
                            <input type="text" name="password" id="password" class="form-control" path="password"/>
                        </div>
                        <div class="form-group">
